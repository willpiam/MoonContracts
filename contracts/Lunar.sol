...
// author:     $wildoy On Cardano, WilliamDoyle.eth On EVM

import "./ILunar.sol";

contract Lunar is ILunar {
    ...
    function numberOfSynodicMonthsSince(uint256 moment) public view returns (uint256) {
        return ((block.timestamp - moment) * 1 gwei) / synodicMonth;
    }
